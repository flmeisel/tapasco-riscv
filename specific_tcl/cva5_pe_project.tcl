...
connect_bd_intf_net [get_bd_intf_pins cva5_0/m_axi_cache] [get_bd_intf_pins axi_mem_intercon_1/S00_AXI]
...
proc create_specific_addr_segs {} {
  ...
  create_bd_addr_seg -range $lmem -offset $lmem [get_bd_addr_spaces cva5_0/m_axi_cache] [get_bd_addr_segs rv_dmem_ctrl/S_AXI/Mem0] SEG_rv_dmem_ctrl_Mem0
  create_bd_addr_seg -range $lmem -offset 0x00000000 [get_bd_addr_spaces cva5_0/m_axi_cache] [get_bd_addr_segs rv_imem_ctrl/S_AXI/Mem0] SEG_rv_imem_ctrl_Mem0
}
